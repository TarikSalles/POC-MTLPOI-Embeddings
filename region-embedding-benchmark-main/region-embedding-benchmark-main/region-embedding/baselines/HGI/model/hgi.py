    ...
    def forward(self, data):
        ...
        for region in range(torch.max(data.region_id)+1):
            ...
            if hard_negative_choice < 0.25:
                # candidatos "duros": regiões com similaridade em (0.6, 0.8)
